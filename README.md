...
| 档位 | 下载大小 | 内置下载地址 |
| --- | ---: | --- |
| SAM 2.1 Hiera Base+（quantized ONNX） | 103.6 MiB | [幻画模型镜像](https://hs.atmomo.cn/model/) |
